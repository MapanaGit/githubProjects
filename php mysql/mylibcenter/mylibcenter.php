  ...
  <div class="navigation w-100">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark p-0">
        <a class="navbar-brand" href="mylibcenter.php"><img src="images/mylogocenter.png" alt="logo"></a>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="mylibcenter.php">Mylibcenter</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted">Welcome to Mylibcenter Administration Dashboard</li>
        </ul>
        <p class="text-lighten mb-0">Admin is given full management control over the system.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow" style="background-color:orange;">
      ...
      <div class="card-body">
        ...
        <a href="returnbook.php" class="btn btn-primary btn-sm">Return Book</a>
      </div>
    </div>
  </div>
