...
session_start();
     ...
     if(isset($_POST['submit'])){
       ...
       $password = $_REQUEST['password'];
        ...
        $sql = "INSERT INTO student VALUES ('$studentid','$name','$surname','$address','$phone','$email','$coursename','$password')";
         
        if(mysqli_query($conn, $sql)){
            echo "<script>alert('Account has been created successfully')</script>";
           
        } else{
            echo "<script>alert('Failed creating an account. please try again!')</script>";
...
<head>
  ...
  <!-- Basic Page Needs
	================================================== -->
  <meta charset="utf-8">
  <title>Student details | Mylibcenter</title>
  ...
  <div class="navigation w-100">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark p-0">
        <a class="navbar-brand" href="index.html"><img src="images/mylogocenter.png" alt="logo"></a>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="userlogin.php">Mylibcenter</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted">Create an account</li>
        </ul>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 order-2 order-md-1">
        ...
        <form action="student.php" method="post" class="row" name="login" onsubmit="return(validate());">
                        <div class="col-12">
                            <input type="number" class="form-control mb-3" id="studentid" name="studentid" placeholder="please enter student id">
                        </div>
                        <div class="col-12">
                  ...
                  if($conn === false){
                      die("ERROR: Could not connect. "
                        ...
                        <div class="col-12">
                            <button type="submit" name="submit" id="submit" value="submit" class="btn btn-primary">Save</button><br /><br />
                            Already a member? click <a href="userlogin.php">here</a> to login
                        </div>
                    </form>
...
function validate(){
  ...
  if(document.login.lecturerid.value==""){
		alert('please enter lecturer Id');
		document.login.lecturerid.focus();
		return false;
	}
