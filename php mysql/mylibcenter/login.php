<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         ...
         header("location: mylibcenter.php");
...
<head>
  ...
  <!-- Basic Page Needs
	================================================== -->
  <meta charset="utf-8">
  <title>Login Modal | Mylibcenter</title>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 order-2 order-md-1">
        <h2 class="section-title">Login panel</h2>
        <form action="login.php" method="post" class="row" name="login" onsubmit="return(validate());">
