...
$sql = "SELECT * FROM emergency_contacts"; // Assuming you have a 'contacts' table in your database
...
<body>
    ...
    <div class="container">
        ...
        <!-- Search Box -->
        <input type="text" id="search" class="search-box" onkeyup="searchContacts()" placeholder="Search contacts...">
