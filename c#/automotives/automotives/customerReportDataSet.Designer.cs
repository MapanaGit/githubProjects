...
namespace automotives {
    ...
    public partial class customerReportDataSet : global::System.Data.DataSet {
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public customerRow AddcustomerRow(long customer_id, string cust_name, long cust_phone, string address, string email) {
...
namespace automotives.customerReportDataSetTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[customer] WHERE (([customer_id] = @Original_customer_id) AND (" +
                "[cust_name] = @Original_cust_name) AND ([cust_phone] = @Original_cust_phone) AND" +
                " ([address] = @Original_address) AND ([email] = @Original_email))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[customer] ([customer_id], [cust_name], [cust_phone], [address], [email]) VALUES (@customer_id, @cust_name, @cust_phone, @address, @email);
SELECT customer_id, cust_name, cust_phone, address, email FROM customer WHERE (customer_id = @customer_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[customer] SET [customer_id] = @customer_id, [cust_name] = @cust_name, [cust_phone] = @cust_phone, [address] = @address, [email] = @email WHERE (([customer_id] = @Original_customer_id) AND ([cust_name] = @Original_cust_name) AND ([cust_phone] = @Original_cust_phone) AND ([address] = @Original_address) AND ([email] = @Original_email));
SELECT customer_id, cust_name, cust_phone, address, email FROM customer WHERE (customer_id = @customer_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT customer_id, cust_name, cust_phone, address, email FROM dbo.customer";
        ...
        public virtual int Fill(customerReportDataSet.customerDataTable dataTable) {
        ...
        public virtual customerReportDataSet.customerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            customerReportDataSet.customerDataTable dataTable = new customerReportDataSet.customerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(customerReportDataSet.customerDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(customerReportDataSet dataSet) {
        ...
        public virtual int Delete(long Original_customer_id, string Original_cust_name, long Original_cust_phone, string Original_address, string Original_email) {
        ...
        public virtual int Insert(long customer_id, string cust_name, long cust_phone, string address, string email) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((long)(cust_phone));
            if ((address == null)) {
        ...
        public virtual int Update(long customer_id, string cust_name, long cust_phone, string address, string email, long Original_customer_id, string Original_cust_name, long Original_cust_phone, string Original_address, string Original_email) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((long)(cust_phone));
            if ((address == null)) {
                throw new global::System.ArgumentNullException("address");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((long)(Original_customer_id));
            if ((Original_cust_name == null)) {
                throw new global::System.ArgumentNullException("Original_cust_name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((long)(Original_cust_phone));
            if ((Original_address == null)) {
                throw new global::System.ArgumentNullException("Original_address");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string cust_name, long cust_phone, string address, string email, long Original_customer_id, string Original_cust_name, long Original_cust_phone, string Original_address, string Original_email) {
            return this.Update(Original_customer_id, cust_name, cust_phone, address, email, Original_customer_id, Original_cust_name, Original_cust_phone, Original_address, Original_email);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(customerReportDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(customerReportDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(customerReportDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._customerTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(customerReportDataSet dataSet) {
            if ((dataSet == null)) {
